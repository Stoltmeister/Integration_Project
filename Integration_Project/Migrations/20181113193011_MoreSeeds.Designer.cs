...
namespace Integration_Project.Migrations
{
    ...
    [Migration("20181113193011_MoreSeeds")]
            ...
            modelBuilder.Entity("Integration_Project.Models.Participant", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new { Id = "4", ConfirmedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), EventId = "2", InvitedBy = "b7813711-0140-4696-b984-8bd4569c7bba", InvitedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), UserId = "b7813711-0140-4696-b984-8bd4569c7bba" },
                        new { Id = "5", ConfirmedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), EventId = "1", InvitedBy = "b7813711-0140-4696-b984-8bd4569c7bba", InvitedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), UserId = "b7813711-0140-4696-b984-8bd4569c7bba" },
                        new { Id = "6", ConfirmedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), EventId = "2", InvitedBy = "b7813711-0140-4696-b984-8bd4569c7bba", InvitedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), UserId = "b7813711-0140-4696-b984-8bd4569c7bba" }
                    );
                });
